...
import com.example.alexcalle.beaconbooking3.RestClient;
import com.example.alexcalle.beaconbooking3.RestClientListener;
import com.example.alexcalle.beaconbooking3.RestClientResult;
...
//    public void updateUser(final Employee employee) {
//
//        Gson gson = new Gson();
...
//    }
    ...
    public void updateUser(final Employee employee, EmployeePutListener putListener) {
    ...
    public void onResult(RestClientResult result) {
        //Responsekoden blir alltid 200, men går ändå in i EmployeePostSuccess, dock inte PutSuccess
        Log.d("result", "result: " + result.responseCode);
...
//            this._getListener.onEmployeeGetFailure();
    ...
    private void Execute(String empId, String jsonEmployee, String idToken){
        ...
        RestClient restClient = new RestClient(url, method, headers, jsonEmployee, null);
        restClient.execute();
    }
}
